    ...
    render(){
        ...
        return(
            <React.Fragment>
                ...
                {/* Start About Area  */}
                <div className="rn-about-area ptb--120 bg_color--1" style={{background:"#191919"}}>
                                ...
                                <div className="col-lg-7">
                                    <div className="about-inner inner">
                                        <div className="section-title">
                                            ...
                                            <p className="description" style={{color:"#fff"}}>Welcome to our overseas recruitment company! We are a leading global HR recruitment company that specializes in connecting talented individuals with exciting job opportunities overseas. 
...
With years of experience in the industry, we have built a strong network of international clients and candidates, enabling us to match the right talent with the right job, regardless of geographical boundaries.
 ...
 <br/> </p>
                ...
                {/* End About Area  */}
                 ...
                 <div className="rn-counterup-area pb--120 bg_color--1" style={{background:"#101010"}}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title text-center" style={{marginTop:"60px"}}>
                                    <h3 className="fontWeight500" style={{color:"#fff"}}>Our Fun Facts</h3>
                                </div>
                            </div>
                        </div>
                        <CounterOne />
                ...
                {/* Start Team Area  */}
                <div className="rn-team-area bg_color--1 ptb--120" style={{background:"#191919"}}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title service-style--3 text-center mb--25">
                                    <h2 className="title" style={{color:"#fff"}}>Skilled Team</h2>
                                    <p style={{color:"#fff"}}>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
