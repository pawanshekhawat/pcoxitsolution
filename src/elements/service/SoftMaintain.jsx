        ...
        >
          <div className="overlayServices">
            ...
            >
              ...
              <p className="text-white mb-8">{t("sm_main_desc")}</p>
            ...
            <div className="row mx-auto">
              ...
              <div className="col-md-6 col-lg-6 mb-4 cardPadAlign">
                <div className="DevProg p-4 bg_color--5 rounded shadow-sm">
                  ...
                  <p id="redirect">{t("sm_process1_4_desc")}</p>
                </div>
              </div>
            </div>
          </div>
